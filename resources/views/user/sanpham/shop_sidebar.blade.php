                                ...
                                <div class="product-inner">
                                    ...
                                    <div class="content">
                                        <h4 class="sub-title"><a
                                                href="single-product.html">{{ $product->categories->name }}</a>
                                        </h4>
                                        <h5 class="title"><a
                                        ...
                                        <span class="price">
                                            @if ($product->discount_price)
                                                <span
                                                    class="new">{{ number_format($product->discount_price, 0, '', '.') }}
                                                    ₫</span>&nbsp;&nbsp;
                                ...
                                <nav>
                                    @if (!empty($categories))
                                        @foreach ($categories as $category)
                                            <ul class="category-menu mb-n3 sidebar-list">
                                ...
                                <div class="sidebar-body">
                                    <ul class="sidebar-list">
                                        @foreach ($colors as $color)
                                            <li>
                                                <form action="{{ route('product.locMau', $color->color_id) }}"
                                                    method="post" class="d-inline">
                                                    @csrf
                                                    <input type="hidden" name="color_id"
                                                        value="{{ $color->color_id }}">
                                                    <button type="submit"
                                                        class="btn btn-link p-0 text-decoration-none fw-normal">{{ $color->value }}</button>
                                                </form>
                                            </li>
                                        @endforeach
                                    </ul>
