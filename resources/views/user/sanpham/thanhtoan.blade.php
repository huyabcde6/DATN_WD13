            ...
            voucherForm.addEventListener('submit', function(e) {
                ...
                fetch("{{ route('vocher') }}", {
                    ...
                    .then(data => {
                        // Kiểm tra nếu có lỗi
                        if (data.error) {
                            voucherMessage.innerHTML = `<div class="alert alert-danger">${data.error}</div>`;
                            discountDisplay.textContent = '0 ₫'; // Reset giá trị giảm giá
                            totalDisplay.textContent = `{{ number_format($total, 0, ',', '.') }} ₫`; // Reset tổng giá trị
                    ...
                    .catch(error => {
                        ...
                        voucherMessage.innerHTML = `<div class="alert alert-danger">Đã xảy ra lỗi, vui lòng thử lại sau.</div>`;
                    });
            });
        });
    </script>
