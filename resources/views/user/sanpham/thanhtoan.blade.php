                ...
                <div class=" mt-4">
                    <div class="apply-coupon-wrapper d-flex">
                        <form id="voucher-form" action="{{ route('vocher') }}" method="post" class="d-flex">
                            ...
                            <button id="apply-voucher" class="btn btn-dark btn-hover-primary rounded-0 ms-2 form-control">
                                Áp dụng mã</button>
                        </form>
                    </div>
                </div>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end"><strong
                                                        id="total-display">{{ number_format($total, 0, ',', '.') }}
                                                        ₫</strong></td>
                                                <input type="hidden" id="total-input" name="total_price"
                                                    value="{{ $total }}">
                                            </tr>
                                        </tfoot>
                                    </table>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                voucherForm.addEventListener('submit', function(e) {
                    ...
                    fetch("{{ route('vocher') }}", {
                            ...
                            body: JSON.stringify({
                                voucher: voucherCode,
                                total: '{{ $total }}' // Truyền tổng giá trị đơn hàng vào backend
                            })
                        })
...
@endsection
>>>>>>> f84b2476360889b0806d87c53689b13e5294d2c0
