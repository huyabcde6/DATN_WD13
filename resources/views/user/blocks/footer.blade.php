     ...
     <div class="footer-top section-padding">
         <div class="container">
             <div class="row mb-n10">
                 <div
                     class="col-12 col-sm-6 col-lg-4 col-xl-4 mb-10"
                     data-aos="fade-up"
                     data-aos-delay="200">
                     <div class="single-footer-widget">
                         <h2 class="widget-title">Liên hệ với chúng tôi</h2>
                         <p class="desc-content">
                             Đơn giản, hiện đại, thời trang cho mọi người.
                         </p>
                         <!-- Contact Address Start -->
                         <ul class="widget-address">
                             <li>
                                 <span>Địa chỉ: </span> Bắc Từ Liêm - Hà Nội
                             </li>
                             <li>
                                 <span>Liên hệ: </span>
                                 <a href="#"> 0973320198</a>
                             ...
                             <li>
                                 <span>Email: </span> <a href="#"> huyabcde6@gmail.com</a>
                             </li>
                         </ul>
                         <!-- Contact Address End -->
                 ...
                 <div
                     class="col-12 col-sm-6 col-lg-2 col-xl-2 mb-10"
                     data-aos="fade-up"
                     data-aos-delay="300">
                     <div class="single-footer-widget">
                         ...
                         <ul class="widget-list">
                             ...
                             <li><a href="about.html">Thông tin giao hàng</a></li>
                             <li><a href="about.html">Chính sách bảo mật</a></li>
                             <li><a href="about.html">Điều khoản & Điều kiện</a></li>
                             <li><a href="about.html">Dịch vụ khách hàng</a></li>
                             <li><a href="about.html">Chính sách hoàn trả</a></li>
                         </ul>
                     </div>
                 </div>
                 <div
                     ...
                     <div class="single-footer-widget aos-init aos-animate">
                         ...
                         <ul class="widget-list">
                             ...
                             <li><a href="contact.html">Bản tin</a></li>
                             <li><a href="contact.html">Trung tâm trợ giúp</a></li>
                             <li><a href="contact.html">Tình trạng</a></li>
                             ...
                             <div class="newsletter-form-wrap pt-4">
                                 <form id="mc-form" class="mc-form">
                                     <input
                                         type="email"
                                         id="mc-email"
                                         class="form-control email-box mb-4"
                                         placeholder="Nhập email của bạn vào đây.."
                                         name="EMAIL" />
                                     <button
                                         id="mc-submit"
                                         class="newsletter-btn btn btn-primary btn-hover-dark"
                                         type="submit">
                                         Đặt mua
                                     </button>
                                 </form>
 ...
 <!-- Modal Start  -->
 <div
     class="modalquickview modal fade"
             ...
             <div class="row">
                         ...
                         <div class="swiper-container">
                             <div class="swiper-wrapper">
                                 <a class="swiper-slide" href="#">
                                     <img
                                         class="w-100"
                                         src="{{ asset('ngdung/assets/images/products/large-size/1.jpg')}}"
                                         alt="Product" />
                                 </a>
                                 <a class="swiper-slide" href="#">
                                     <img
                                         class="w-100"
                                         src="{{ asset('ngdung/assets/images/products/large-size/2.jpg')}}"
                                         alt="Product" />
                                 </a>
                                 <a class="swiper-slide" href="#">
                                     <img
                                         class="w-100"
                                         src="{{ asset('ngdung/assets/images/products/large-size/3.jpg')}}"
                                         alt="Product" />
                                 </a>
                                 <a class="swiper-slide" href="#">
                                     <img
                                         class="w-100"
                                         src="{{ asset('ngdung/assets/images/products/large-size/4.jpg')}}"
                                         alt="Product" />
                                 </a>
                                 <a class="swiper-slide" href="#">
                                     <img
                                         class="w-100"
                                         src="{{ asset('ngdung/assets/images/products/large-size/5.jpg')}}"
                                         alt="Product" />
                                 </a>
                                 <a class="swiper-slide" href="#">
                                     <img
                                         class="w-100"
                                         src="{{ asset('ngdung/assets/images/products/large-size/6.jpg')}}"
                                         alt="Product" />
                                 </a>
                             </div>
                 ...
                 <div class="col-md-6 col-12 overflow-hidden position-relative">
                     ...
                     <div class="product-summery">
                         ...
                         <ul
                             class="product-delivery-policy border-top pt-4 mt-4 border-bottom pb-4">
                             <li>
                                 <i class="fa fa-check-square"></i>
                                 <span>Security Policy (Edit With Customer Reassurance
                                     Module)</span>
                             </li>
                             <li>
 ...
 <script src="{{ asset('ngdung/assets/js/vendor/jquery-3.6.0.min.js')}}"></script>
 <script src="{{ asset('ngdung/assets/js/vendor/jquery-migrate-3.3.2.min.js')}}"></script>
 <script src="{{ asset('ngdung/assets/js/vendor/modernizr-3.11.2.min.js')}}"></script>

 <!-- Plugins JS -->

 <script src="{{ asset('ngdung/assets/js/plugins/countdown.min.js')}}"></script>
 <script src="{{ asset('ngdung/assets/js/plugins/aos.min.js')}}"></script>
 <script src="{{ asset('ngdung/assets/js/plugins/swiper-bundle.min.js')}}"></script>
 <script src="{{ asset('ngdung/assets/js/plugins/nice-select.min.js')}}"></script>
 <script src="{{ asset('ngdung/assets/js/plugins/jquery.ajaxchimp.min.js')}}"></script>
