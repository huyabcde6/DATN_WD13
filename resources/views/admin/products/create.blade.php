                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <div class="mb-3">
                                        ...
                                        <select name="categories_id" id="categories_id" class="form-select">
                                            @foreach ($categories as $category)
                                                <option @if (old('categories_id') == $category->id) selected @endif
                                    ...
                                    <div class="col-lg-12">
                                        <div class="button-group">
                                            ...
                                            <div class="options" id="sizes">
                                                @foreach ($sizes as $size)
                                                    <button type="button"
                                                        class="option-button {{ in_array($size->size_id, old('selected_sizes', [])) ? 'selected' : '' }}"
                                                        data-value="{{ $size->size_id }}">
                                                        {{ $size->value }}
                                                    </button>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="button-group">
                                            ...
                                            <div class="options" id="colors">
                                                @foreach ($colors as $color)
                                                    <button type="button"
                                                        class="option-button {{ in_array($color->color_id, old('selected_colors', [])) ? 'selected' : '' }}"
                                                        data-value="{{ $color->color_id }}">
                                                        {{ $color->value }}
                                                    </button>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <button type="button" id="generate-variants" class="btn btn-primary">Tạo
                                                biến thể</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" id="submit-form" class="btn btn-primary">Lưu sản phẩm</button>
                                </div>
                            </div>
                        </form>
                    </div>
